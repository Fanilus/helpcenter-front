...
export { default as VerticalSlider } from './VerticalSlider/VerticalSlider';
...
export { default as CheckMarck } from '../Icons/CheckMarck/CheckMarck';
export { default as ArrowDown } from '../Icons/Arrow/ArrowDown';
export { default as ETHIcon } from '../Icons/ETHIcon/ETHIcon';
export { default as USDCIcon } from '../Icons/USDCIcon/USDCIcon';
